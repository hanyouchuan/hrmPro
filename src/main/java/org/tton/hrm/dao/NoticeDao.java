...
import org.tton.hrm.dao.provider.NoticeDynaSqlProvider;
...
/**
 * 
 * ClassName: NoticeDao <br/>
 * Description: TODO <br/>
 * Date: 2018年3月23日 下午10:43:02 <br/>
 * <br/>
 * 
...
public interface NoticeDao {
	...
	@Results({
		...
		@Result(column="USER_ID",property="user",
			one=@One(select="org.tton.hrm.dao.UserDao.selectById",
