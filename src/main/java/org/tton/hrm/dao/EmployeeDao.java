...
import org.tton.hrm.dao.provider.EmployeeDynaSqlProvider;
import org.tton.hrm.domain.Employee;

import static org.tton.hrm.util.common.HrmConstants.EMPLOYEETABLE;

/**
 * 
 * ClassName: EmployeeDao <br/>
 * Description: TODO <br/>
 * Date: 2018年3月23日 下午10:40:00 <br/>
 * <br/>
 * 
...
public interface EmployeeDao {
    ...
    @Results({
        ...
        @Result(column="DEPT_ID",property="dept",
            one=@One(select="org.tton.hrm.dao.DeptDao.selectById",
        fetchType=FetchType.EAGER)),
        @Result(column="JOB_ID",property="job",
            one=@One(select="org.tton.hrm.dao.JobDao.selectById",
        fetchType=FetchType.EAGER))
    })
