...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr><td id="navbg6" class="left_nav_closed" ><div class="font1">延时加班</div></td></tr>
		  <tr valign="top" id="submenu6" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/overtime/selectOvertimeProject" target="main">加班列表</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/overtime/addOvertimeProject?flag=1" target="main">添加加班</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  
		  <tr><td id="navbg7" class="left_nav_closed" ><div id="click_here" class="font1">点击</div></td></tr>
		  <tr valign="top" id="submenu7" style="display: none">
		  </tr>
		  <tr><td height="2"></td></tr>
		 
		  <tr valign="top"><td height="100%" align="center"><div class="copycct"><br /><strong>tton：</strong><br><strong>demo</strong><br>qq:376763947</div></td></tr>
